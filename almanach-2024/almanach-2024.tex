\documentclass[a5paper, 11pt, twoside, draft]{article}
...
%% TODO JVLS a PVLS jeden sloupec
\renewcommand*{\arraystretch}{1.1}
\begin{longtable}[]{%
...
%% TODO poslední řádek na stránce
...
Dalšími viditelnými osobami jsou náčelník a náčelnice. U~děvčat to byla dlouho Věra Decastellová a následně Dana Blahunková, Alena Krásová a
...
%% TODO optimalizovat rozložení a odlomené řádky, můžem udělat kapitolku na slet
...
%% TODO nové rozvržení tabulky
 \textbf{Rok} & \textbf{Název tábora / táborová hra}  &  \textbf{Počet PK + členů}  &  \textbf{Tábořiště}  &  \textbf{Táborová/celoroční hra}  \\

\hline \endhead

1981 & \multicolumn{2}{>{\raggedright\arraybackslash}p{4cm}}{Tábor kapitána Foxe (před založením JILMu) } &  Chřenovice  &  Kapitán Fox  \\
 1982 & Tábor pod Javorovou skálou \newline Kapitán Fox  &  4 + 15  &  Jetřichovice  &  Kapitán Fox  \\
 1983 & Tábor pod uříznutým stožárem \newline Jan Kornel  &  3 + 16  &  Jetřichovice  &  Jan Kornel  \\
...
%% TODO samotný obrázek na vrček stránky
\begin{figure}[t]
  \centering
